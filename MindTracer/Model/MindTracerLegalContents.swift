...
struct MindTracerLegalContents {
    ...
    let copyright = "© 2026 ModalFlo Mobile Solutions. All rights reserved. \n\nMind Tracer and its associated content, design, and software are the intellectual property of ModalFlo Mobile Solutions. \n\nUnauthorized copying, distribution, or use of this application or its content is strictly prohibited."
    let contact = "ModalFlo Mobile Solutions\n\nPhone: +1 949-345-0034\n\nAdmin & Support Email: support@modalflo.com"
}
